...
def xyxy2xywh_2(coord, im0):
    ...
    cv2.circle(im0, (xc,yc), radius = 1, color = (0,0,255), thickness = 2)
    cv2.putText(im0, str(xc)+str(yc), (20, 130), cv2.FONT_HERSHEY_PLAIN, 3, (0, 196, 255), 2)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    dict_nc[names[int(c)]] = n.item()
                for i1, j1 in enumerate(dict_nc):
                    #cv2.putText(im0, str(j1)+':'+str(dict_nc[j1]), (20, 570+i1*15), cv2.FONT_HERSHEY_PLAIN, 1, (0, 196, 255), 2)
                    cv2.putText(im0, str(j1)+':'+str(dict_nc[j1]), (20, 570+i1*25), cv2.FONT_HERSHEY_SIMPLEX, 1, colors[i1], 2)
